...
{
    [DbContext(typeof(CalwayPestDbContext))]
    [Migration("20260208184436_AddInvoiceTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CalwayPest.ContactSubmission", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<string>("FormSource")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasDefaultValue("ContactForm");
                    ...
                    b.ToTable("AppContactSubmissions", (string)null);
                });

            modelBuilder.Entity("CalwayPest.Domain.AdminUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppAdminUsers", (string)null);
                });

            modelBuilder.Entity("CalwayPest.Domain.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("GstTotalAmount")
            ...
            modelBuilder.Entity("CalwayPest.Domain.InvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CalwayPest.Domain.InvoiceItem", b =>
                {
                    b.HasOne("CalwayPest.Domain.Invoice", "Invoice")
                        .WithMany("Items")
