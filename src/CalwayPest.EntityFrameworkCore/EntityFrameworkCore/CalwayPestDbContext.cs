...
public class CalwayPestDbContext :
    AbpDbContext<CalwayPestDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public CalwayPestDbContext(DbContextOptions<CalwayPestDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(CalwayPestConsts.DbTablePrefix + "YourEntities", CalwayPestConsts.DbSchema);
